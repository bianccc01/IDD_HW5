...
class NGramClassifier(Classifier):
    ...
    def fit(self, data):
        ...
        self.lrm = linear_model.LogisticRegression(class_weight='balanced', max_iter=1500)
    ...
    def predict_training(self, folds=5):
        ...
        """
        partial_clf = linear_model.LogisticRegression(class_weight='balanced', max_iter=1500)
